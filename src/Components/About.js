  ...
  return (
    <div className="about-container">
      ...
      <div className="about-list">
        <img className="my-pic" src={Me} alt="a woman"></img>
        <h1>
          This site was built with React, caffeine, and some funny photos of my
          cat.
        </h1>
        <h1>
          I'd love to work on a project with you and build something great
          together.{" "}
          <a
            className="highlight"
