  ...
  return (
    ...
    <div className="intro" >
      <h1>Hey! I'm <span className="highlight" onMouseEnter={handleMouseOver} onMouseLeave={handleMouseOut}> Rosie{hover && <img src={Rose} onMouseMove={(e)=>{moveMouseImg(e)}} style={styles}/>}</span>, a Software Engineer based in Brooklyn.</h1>
       ...
       <h1>Check out my  <NavLink to="/projects" className="highlight">projects</NavLink> and <a href="https://drive.google.com/file/d/1IpxyoxvHZyOWafAPrO8sQAK6GcEXIYdn/view?usp=sharing"  className="highlight">resume</a> for more.</h1>
